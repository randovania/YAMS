...
- The Bomb sprites (`offworld items/primes/prime1/bombs`) were made by [LaKompetenzia](https://www.twitch.tv/ilakompetenzia) and [AbyssalCreature](https://github.com/AbyssalCreature)
...
- The Charge Beam sprites (`offworld items/primes/prime1/chargeBeam`) were made by [AbyssalCreature](https://github.com/AbyssalCreature)
...
- The Energy Tank sprites (`offworld items/primes/prime1/eTank`) were made by [AbyssalCreature](https://github.com/AbyssalCreature)
...
- The Missile Expansion sprites (`offworld items/primes/prime1/missileExpansion`) were made by [AbyssalCreature](https://github.com/AbyssalCreature)
...
- The Missile Launcher sprites (`offworld items/msr/missileLauncher`) were made by [AbyssalCreature](https://github.com/AbyssalCreature)
