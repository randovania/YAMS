...
public class Patcher
{
    ...
    public static void Main(string am2rPath, string outputAm2rPath, string jsonPath)
    {
        ...
        sw.Stop();
        var timeRightAfterReading = sw.Elapsed;
        sw.Start();
        ...
        sw.Stop();
        var timeRightBeforeReading = sw.Elapsed;
        sw.Start();
        // Write back to disk
        ...
        Console.WriteLine($"Patching time only: {timeRightBeforeReading-timeRightAfterReading}");
    }
}
